...
<?php
  if(is_post_request()) {
    if($_POST['FirstName'] != get_first_name('customer', $_POST['Email'])){
      ...
      redirect_to(url_for('/user/staff/cash-withdrawal.php#message'));
    }
    if($_POST['Acc_Num'] != get_account_number($_POST['Email'])) {
      $_SESSION['Message'] = "Invalid account number entered, please try again.";
      redirect_to(url_for('/user/staff/cash-withdrawal.php#message'));
    }
    if($_POST['DebitAmount'] > get_account_balance($_POST['Acc_Num'])) {
      $_SESSION['Message'] = "Insufficent account account balance, please try again.";
      redirect_to(url_for('/user/staff/cash-withdrawal.php#message'));
    }
    $result = remove_account_balance($_POST['Acc_Num'], intval($_POST['DebitAmount']), "Cash Withdrawal by Self");
    if($result) {
      $_SESSION['Message'] = "Cash withdrawal successfull.";
...
<html lang="en">
  <head>
    ...
    <title>Cash Withdrawal | Dashboard</title>
  </head>
  <body>
    ...
    <div class="header">
      <div class="centeredXY">
        ...
        <p class="header-paragraph">Please fill the details below to withdraw cash.</p>
      </div>
    </div>
    <!-- Header -->
      ...
      <div class="content-area-content container">
        ...
        <div class="row">
          <div class="col-11 mx-auto">
            <h1 class="content-area-heading text-center" id="message">Cash Withdrawal</h1>
            ...
            <div class="row">
              <div class="col-md-4 mx-auto">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="<?php echo url_for('/user/staff/cash-withdrawal.php'); ?>" method="post">
                      <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="tel" name="DebitAmount" placeholder="Amount" id="DebitAmount" required>
                      </div>
