...
<html lang="en">
  <head>
    ...
    <title> <?php echo $_SESSION['FirstName']; ?> | View Staffs | Dashboard</title>
  </head>
  <body>
    ...
    <div class="header">
      <div class="centeredXY">
        ...
        <p class="header-paragraph">See below all the Staff Accounts.</p>
      </div>
    </div>
    <!-- Header -->
    ...
    <div class="content-area">
      <div class="content-area-content container">
        <form  action="<?php echo url_for('/user/admin/dashboard.php'); ?>" method="post">
          <button class="btn btn-dark dashboard-button" type="submit">Dashboard</button>
        </form>
        <div class="row">
          <div class="col-11 mx-auto">
            <h1 class="content-area-heading text-center">Staff Accounts</h1>
            <?php if(mysqli_num_rows(get_staff_accounts()) != 0) { ?>
                ...
                <tbody>
                  <?php
                    ...
                    <tr>
                      ...
                      <td><form action="<?php echo url_for('user/admin/view-staff-details.php'); ?>" method="post">
            ...
            <?php } else { ?>
              <h4 class="text-center" style="margin-bottom: 10rem;">There are currently no Staff Accounts.</h3>
            <?php } ?>
          </div>
        </div>
      </div>
