...
<html lang="en">
  <head>
    ...
    <title> <?php echo $_SESSION['FirstName']; ?> | Add Staff | Dashboard</title>
  </head>
  <body>
    ...
    <div class="header">
      <div class="centeredXY">
        ...
        <p class="header-paragraph">Please fill the form below to add new Staff.</p>
      </div>
    </div>
    <!-- Header -->
    ...
    <div class="form-area">
      <div class="form-area-content container">
        ...
        <div class="row">
          <form method="post" action="<?php echo url_for('/user/admin/submit.php'); ?>"class="mx-auto col-10">
            <div class="form-row ">
